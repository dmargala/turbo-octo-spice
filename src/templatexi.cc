...
int main(int argc, char **argv) {
    ...
    typedef tos::XiEstimator<tos::BrutePairSearch<tos::Pixels>, tos::DoNothing> SimpleXi;
    ...
    typedef tos::XiEstimator<tos::BrutePairSearch<tos::Pixels>, tos::PrintPair> WeightedXi;
